...
## 需要设置目录后修改后面 bin 目录：
cp ./bin/cfssl_linux-amd64 /opt/k8s/bin/cfssl
cp ./bin/cfssljson_linux-amd64 /opt/k8s/bin/cfssljson
cp ./bin/cfssl-certinfo_linux-amd64 /opt/k8s/bin/cfssl-certinfo
